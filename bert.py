...
def fine_tune_bert(data_name, dimension, max_length, num_samples=1000):
    ...
    model_path = '../{}_dataset/bert_models_2/dim.{}.samples.{}'.format(data_name, dimension, num_samples)
    ...
    for dim in grade_dims:
        for num_samples in samples:
            ...
            for data_type in ['train', 'test.val']:
                output_dir = '../{}_dataset/bert_embeddings_2/dim.{}.samples.{}.{}'.format(data_name, dim, num_samples,
                                                                                         data_type)
