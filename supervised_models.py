...
def run_experiments():
    data_name = {1: 'iclr17', 2: 'education', 3: 'iclr17_new'}[int(sys.argv[1])]
    topic_model_type = sys.argv[2]
    data_dir = '/home/skuzi2/{}_dataset'.format(data_name)
    test_dimensions = {'education': [0, 1, 2, 3, 4, 5, 6], 'iclr17': [1, 2, 3, 5, 6], 'iclr17_new': [1, 2, 3, 5, 6]}[data_name]
    topic_model_dims = [[5]]
    ...
    combination_methods = ['comb_sum', 'feature_comb'] # 'comb_model', ['comb_sum', 'comb_rank', 'feature_comb']
