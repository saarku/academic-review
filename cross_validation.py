    ...
    for test_dim in test_dimensions:
        ...
        if combination_method == 'feature_comb':
            ...
            for vec_dim in train_vectors[test_dim]:
                ...
                val_split = int(len(all_train_ids) * 0.25)
...
def run_topics_experiment():
    ...
    features = [pos_features] #[pos_features, neg_features, pos_neg_features, neutral_features] #dimension_features] # dimension_features] #
