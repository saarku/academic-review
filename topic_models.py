...
def get_topic_representations():
    data_name = 'iclr17'
    num_topics = '5'
    topic_identifiers_1 = ['3_1_pos_0',	'3_3_pos_3',	'3_6_pos_4',	'3_6_neg_4']
    ...
    for topic_id in final_words:
        ...
        for word in final_words[topic_id][:30]:
            output_line += ',' + word
        print(output_line)
        ...
        for para in paragraphs:
            for dim in dimensions:
                for mode in dimensions[dim]:
                    for model_type in model_types:
                        for topic in topics:
                            vocab_data_dir = base_dir + '/data_splits/dim.{}.mod.{}.para.{}.train.text'.format(dim, mode, para)
                            ...
                            tm = TopicModels(train_data_dir, vocab_data_dir)
                            ...
                            tm = TopicModels(test_data_dir, vocab_data_dir)
