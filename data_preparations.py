...
def split_by_grade(input_data_dir, grades_dir, dimensions):
    ...
    data_lines = [line.rstrip('\n') for line in open(input_data_dir + 'dim.all.mod.neu.para.1.test.val.text', 'r').readlines()]
    data_ids = [line.rstrip('\n') for line in open(input_data_dir + 'dim.all.mod.neu.para.1.test.val.ids', 'r').readlines()]
    ...
    for dim in dimensions:
        ...
        write_split_to_file(neg_assignments, data_dict, input_data_dir + 'dim.{}.mod.{}.para.1.test.val'.format(dim, 'neg'))
        write_split_to_file(pos_assignments, data_dict, input_data_dir + 'dim.{}.mod.{}.para.1.test.val'.format(dim, 'pos'))
